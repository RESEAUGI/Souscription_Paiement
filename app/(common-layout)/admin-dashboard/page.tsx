            ...
            <table className="w-full whitespace-nowrap">
              <thead>
                <tr className="text-left bg-[var(--bg-1)] border-b border-dashed">
                  ...
                  <th className="py-3 lg:py-4 px-2">Card Number</th>
                  <th className="py-3 lg:py-4 px-2">Validity</th>
                ...
                {payments.map(
                  (payment) => (
                    <tr
                      ...
                      <td className="py-3 lg:py-4 px-2 xl:px-4">{payment.id}</td>
                      <td className="py-3 lg:py-4 px-2 text-primary">
                        {payment.amount}
                      </td>
                      <td className="py-3 lg:py-4 px-2">{payment.date}</td>
                      <td className="py-3 lg:py-4 px-2">{payment.author}</td>

                      <td className={`py-3 lg:py-4 px-2`}>
                        <div className={`w-32`}>
                          {/* <HeadlessList initialValue={status} /> */payment.offer}
                        </div>
                      </td>
                      <td className="py-3 lg:py-4 px-2">
                      ...
                      <td className="py-3 lg:py-4 px-2">
                        <button className="text-primary px-2">
                          {/* <PencilSquareIcon className="w-5 h-5" /> */payment.validity}
                        </button>
